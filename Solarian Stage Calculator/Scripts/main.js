function addSolarianStageCalculator() { // Function for ensuring all the calculator's variables and functions stay within.
    ...
    if (document.getElementById('SolarianStageCalculator') !== null && document.getElementById('SolarianStageCalculatorContainer') === null) {
        ...
        var modeTC = 'ro'; // Determines the conversion method of the Offline Boost Converter.
        ...
        function updateChallenge() { // Update Solarian Challenge data.
            switch (Number(document.getElementById("SSCChallengeInput").value)) {
                case 0:
                    ...
                    document.getElementById("SSCSelectedChallengeText").innerHTML = "None (10x stats, 10.3x health, 300:1 offline boost)";
                    break;
                case 1:
                    challenge = "cycle";
                    enemyStatScaling = new Decimal(10);
                    enemyHealthScaling = new Decimal(10.3);
                    document.getElementById("SSCSelectedChallengeText").innerHTML = "Cycle (10x stats, 10.3x health, 3:1 offline boost)";
                    break;
                case 2:
                    challenge = "wall";
                    enemyStatScaling = new Decimal(50);
                    enemyHealthScaling = new Decimal(50.15);
                    document.getElementById("SSCSelectedChallengeText").innerHTML = "Wall (50x stats, 50.15x health, 300:1 offline boost)";
                    break;
                case 3:
                    challenge = "evil";
                    enemyStatScaling = new Decimal(1e10);
                    enemyHealthScaling = new Decimal(1.03e10);
                    document.getElementById("SSCSelectedChallengeText").innerHTML = "Evil (" + notateInt(1e10) + "x stats, " + notateInt(1.03e10) + "x health, 300:1 offline boost)";
            }
        ...
        function updateResults() { // Update the internal data based on user inputted data, as well as the HTML outputs.
            ...
            if (secondsTC.add(minutesTC).add(hoursTC).add(daysTC).add(yearsTC).greaterThan(0)) {
                ...
                // Return the time output as a string, separated by commas.
                ...
                function genChalList() {
                    ...
                    if (currentStage.greaterThanOrEqualTo(10)) {
                        ...
                        if (currentStage.greaterThan(10)) {
                            ...
                            totalChallengeCompletions += completionsDoable;
                            totalGoldenStars += completionsDoable;
                            totalChallengeScore += 100 * completionsDoable;
        ...
        document.getElementById("SSCTimeConverterModeOutput").addEventListener("click", function() {
            if (modeTC === 'ro') {
                document.getElementById("SSCTimeConverterModeOutput").innerHTML = "Offline boost &gt; Real time";
                modeTC = 'or';
            } else {
                document.getElementById("SSCTimeConverterModeOutput").innerHTML = "Real time &gt; Offline boost";
                modeTC = 'ro';
            }
            updateResults();
        });
