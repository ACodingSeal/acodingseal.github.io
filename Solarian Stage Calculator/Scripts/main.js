function addSolarianStageCalculator() {
	...
	function updateResults() {
		...
		function calcMaxHits() {
			...
			if (enemyDefence.greaterThanOrEqualTo(playerOffence)) {
