...
(function() {
	...
	function addHallofInfamyCCLs() {
		...
		// 1 - 10
		"Achieved CCL in 2024 in IDLW (UTC-12:00) (Anywhere on Earth), less than 13 days after starting the rerelease 43 hours late (contemplating whether to start the long grind train), after grinding on average 15+ hours a day, including staying up for 48 hours (about 95% of which was spent grinding the game), grinding almost exclusively Authority and Shadow Raid, encountering many delays. CCL #1 is also the creator of this tool!",
