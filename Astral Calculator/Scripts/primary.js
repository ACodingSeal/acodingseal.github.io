...
function addAstralCalculator() { // Function for ensuring all the calculator's variables and functions stay within.
    if (document.getElementById("AstralCalculator") !== null && document.getElementById("AstralCalculatorContainer") === null) {
        ...
        const calculatorHTMLPrimaryStatisticsContainer = "<div class='templatedesktop' style='background:initial;border-radius:initial;border-left:0;border-right:0;text-align:center'><span style='font-size:20px'>Main Statistics</span></div><br><img src='./Assets/Astral Calculator/Star.png' width='50'/>Current Astral (<abbr title='Default value: 1.'>notes</abbr>): <input id='ACCurrentAstralInput' style='width:10%'/><p><img src='./Assets/Astral Calculator/Star.png' width='50'/>Desired Astral (<abbr title='Default value: 2.'>notes</abbr>): <input id='ACGoalAstralInput' style='width:10%'/></p><p><img src='./Assets/Astral Calculator/Current Astral Prestige.png' width='50'/>Current Astral Prestige (<abbr title='(n1) Optional. (n2) Default value: 0.'>notes</abbr>): <input id='ACCurrentAstralPrestigeInput' style='width:10%'/></p><p><img src='./Assets/Astral Calculator/SP.png' width='50'/>SP gain per grass cut (<abbr title='This value is according to the Stats Menu, and in-game there is currently a bug where it does not correctly visually output the bonus when at Tier 58+.'>notes</abbr>): <input id='ACSPGainInput' style='width:10%'/></p><p><img src='./Assets/Astral Calculator/Star.png' width='50'/>Percentage until next Astral (<abbr title='(n1) Optional. (n2) Input any value ranging from 0 to 100, without the percentage symbol. (n3) Default value: 0%.'>notes</abbr>): <input id='ACNextAstralCompletionInput' style='width:10%'/>%</p>";
        const calculatorHTMLManualCuttingStatisticsContainer = "<div class='templatedesktop' style='background:initial;border-radius:initial;border-left:0;border-right:0;text-align:center'><span style='font-size:20px'>Manual Cutting Statistics</span></div><p><img src='./Assets/Astral Calculator/Manual Grass Cutting Rate.png' width='50'/>Manual grass cut per second (<abbr title='Leave blank if not manually cutting grass.'>notes</abbr>): <input id='ACManualCuttingRateInput' width='10%'/></p>";
        const calculatorHTMLAutocutStatisticsContainer = "<div class='templatedesktop' style='background:initial;border-radius:initial;border-left:0;border-right:0;text-align:center'><span style='font-size:20px'>Autocut Statistics</span></div><p><img src='./Assets/Astral Calculator/Autocut Rate.png' width='50'/>Autocut rate (<abbr title='(n1) Default value: 0. (n2) Input interval in seconds, such as 0.5 for 2 per second. (n3) Leave blank if autocut is disabled.'>notes</abbr>): <input id='ACAutocutRateInput' width='10%'/></p><p><img src='./Assets/Astral Calculator/Autocut Amount.png' width='50'/>Autocut amount (<abbr title='(n1) Default value: 1. (n2) Leave blank if autocut is disabled.'>notes</abbr>): <input id='ACAutocutAmountInput' width='10%'/></p><p><img src='./Assets/Astral Calculator/Autocut Value.png' width='50'/>Autocut value (<abbr title='(n1) Default value: 1. (n2) Leave blank if autocut is disabled.'>notes</abbr>): <input id='ACAutocutValueInput' width='10%'/></p>";
        const calculatorHTMLResultsAstralBonusesContainer = "<br><br><br><div>Your Astral Bonuses will also become (<u><span id='ACAstralBonusesSectionToggle'>click to toggle</span></u> section visibility):<br><div id='ACAstralBonusesSection' style='display:none'><p>PP increase: x<span id='ACAstralBonusPPBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusPPBonusNextOutput'>?</span></p><p>Crystal bonus: x<span id='ACAstralBonusCrystalBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusCrystalBonusNextOutput'>?</span></p><p>Platinum worth: +<span id='ACAstralBonusPlatinumWorthCurrentOutput'>?</span> > +<span id='ACAstralBonusPlatinumWorthNextOutput'>?</span></p><p>Steel multiplier: x<span id='ACAstralBonusSteelMultiplierCurrentOutput'>?</span> > x<span id='ACAstralBonusSteelMultiplierNextOutput'>?</span></p><p>Grass bonus (AGH Milestone 28GH): x<span id='ACAstralBonusGrassBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusGrassBonusNextOutput'>?</span></p><p>XP bonus (AGH Milestone 25GH): x<span id='ACAstralBonusXPBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusXPBonusNextOutput'>?</span></p><p>TP bonus (AGH Milestone 22GH): x<span id='ACAstralBonusTPBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusTPBonusNextOutput'>?</span></p><p>Stars bonus (AGH Milestone 19GH): x<span id='ACAstralBonusStarsBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusStarsBonusNextOutput'>?</span></p><p>Moonstone bonus (AGH Milestone 16GH): +<span id='ACAstralBonusMoonstoneBonusCurrentOutput'>?</span> > +<span id='ACAstralBonusMoonstoneBonusNextOutput'>?</span></p><p>Charge bonus (AGH Milestone 13GH): x<span id='ACAstralBonusChargeBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusChargeBonusNextOutput'>?</span></p><p>SFRGT bonus (AGH Milestone 10GH): x<span id='ACAstralBonusSFRGTBonusCurrentOutput'>?</span> > x<span id='ACAstralBonusSFRGTBonusNextOutput'>?</span></p><p id='ACAstralBonusDarkMatterBonusContainer' style='display:none'>Dark Matter bonus (Astral Prestige 1): x<span id='ACAstralBonusDarkMatterBonusOutput'>?</span></p><p id='ACAstralBonusNPBonusContainer' style='display:none'>NP bonus (Astral Prestige 2): x<span id='ACAstralBonusNPBonusOutput'>?</span></p><p id='ACAstralBonusRingsBonusContainer' style='display:none'>Rings bonus (Astral Prestige 3): x<span id='ACAstralBonusRingsBonusOutput'>?</span></p><p id='ACAstralBonusDarkFruitsAmountBonusContainer' style='display:none'>Dark Fruits Amount bonus (Astral Prestige 4): x<span id='ACAstralBonusDarkFruitsAmountBonusOutput'>?</span></p><p id='ACAstralBonusLunarPowerBonusContainer' style='display:none'>Lunar Power bonus (Astral Prestige 5): x<span id='ACAstralBonusLunarPowerBonusOutput'>?</span></p><p id='ACAstralBonusArcsBonusContainer' style='display:none'>Arcs bonus (Astral Prestige 6): x<span id='ACAstralBonusArcsBonusOutput'>?</span></p><p id='ACAstralBonusStardustBonusContainer' style='display:none'>Stardust bonus (Astral Prestige 7): x<span id='ACAstralBonusStardustBonusOutput'>?</span></p><p id='ACAstralBonusSolarFlareBonusContainer' style='display:none'>Solar Flare bonus (Astral Prestige 8): x<span id='ACAstralBonusSolarFlareBonusOutput'>?</span></p><p id='ACAstralBonusPrestigePointsBonusContainer' style='display:none'>Prestige Points bonus (Astral Prestige 9): +<span id='ACAstralBonusPrestigePointsBonusOutput'>?</span>%</p></div>";
        const calculatorHTMLResultsContainer = "<div class='templatedesktop' style='background:initial;border-radius:initial;border-left:0;border-right:0;text-align:center'><span style='font-size:20px'>Result</span></div><div style='text-align:center'><br><button id='ACCalculateButton'>Calculate</button><br><br>At Astral <span id='ACCurrentAstralOutput'>?</span> and Astral Prestige <span id='ACCurrentAstralPrestigeOutput'>?</span>, when currently <span id='ACNextAstralCompletionOutput'>?</span>% to next Astral, the requirements to reach Astral <span id='ACGoalAstralOutput'>?</span> are:<br><img src='./Assets/Astral Calculator/SP.png' width='50'/><b>Space Power:</b> <span id='ACSPReqOutput'>?</span><br><img src='./Assets/Astral Calculator/Speed.png' width='50'/><b>Time:</b> <span id='ACTimeReqOutput'>?</span><br><br><b>Highest time name:</b> <u><span id='ACYearsOnlyButton'>Years</span></u> (click to toggle)" + calculatorHTMLResultsAstralBonusesContainer + "</div>";
        document.getElementById("AstralCalculator").innerHTML = "<div id='AstralCalculatorContainer' class='templatedesktop' style='padding:1em;background:#A629FF;width:80%;margin:auto'><div style='text-align:initial;width:20%;padding:1em;background:initial;overflow:auto' class='templatedesktop'>Toggle Suffixes<br><button style='background:#FF0000' id='ACSuffixButton'>Disabled</button></div><div style='text-align:center;font-size:30px'><img src='./Assets/Astral Calculator/Star.png' width='150'/> Astral Calculator <img src='./Assets/Astral Calculator/Star.png' width='150'/></div><br>" + calculatorHTMLPrimaryStatisticsContainer + calculatorHTMLManualCuttingStatisticsContainer + calculatorHTMLAutocutStatisticsContainer + calculatorHTMLResultsContainer + "</div></div>";
