...
function addTierCalculator() {
    if (document.getElementById('TierCalculator') !== null && document.getElementById('TierCalculatorContainer') === null) {
        ...
        function updateResults() {
            ...
            if (goalTier.greaterThan(currentTier)) {
                document.getElementById('TierCalculatorTierChangeOutput').innerHTML = "<span style='color:#00FF00;font-weight:bold'>+" + notateInt(goalTier.sub(currentTier)) + '</span>';
            } else if (currentTier.greaterThan(goalTier)) {
                document.getElementById('TierCalculatorTierChangeOutput').innerHTML = "<span style='color:#FF0000;font-weight:bold'>-" + notateInt(currentTier.sub(goalTier)) + '</span>';
            } else {
                document.getElementById('TierCalculatorTierChangeOutput').innerHTML = "<span style='color:#FFFF00;font-weight:bold'>~0</span>";
            }
        }
        updateResults();
