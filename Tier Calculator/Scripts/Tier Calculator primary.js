...
function addTierCalculator() {
    if (document.getElementById('TierCalculator') !== null && document.getElementById('TierCalculatorContainer') === null) {
        ...
        function updateSuffixStatus() {
            ...
            document.getElementById('TierCalculatorCurrentTierNotes').title = '(n1) Default value: 1. (n2) Values above 100,000 may cause performance issues. It is not recommended to exceed values of ' + notateInt(1e7) + '.';
            document.getElementById('TierCalculatorGoalTierNotes').title = '(n1) Default value: Current Tier + 1. (n2) Values above 100,000 may cause performance issues. It is not recommended to exceed values of ' + notateInt(1e7) + '.';
        }
        updateSuffixStatus();
