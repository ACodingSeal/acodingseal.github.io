...
function addSuffixConverter() {
    if (document.getElementById('SuffixConverter') !== null && document.getElementById('SuffixConverterContainer') === null) {
        ...
        console.log('[Suffix Converter] [LOG] Failed to locate ID or calculator already exists. Cancelling script.');
    }
}
addSuffixConverter();